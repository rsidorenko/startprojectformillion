...
- **Proposed (черновик требований)**: [31 — Public billing webhook / HTTP ingress — MVP security design](31-public-billing-ingress-security.md) — пространство решений по **authenticity**, **replay**, **категориям** отказов и **схождению** с путём нормализованного ingest/ledger **без** кода/провайдера в целом по репозиторию.
